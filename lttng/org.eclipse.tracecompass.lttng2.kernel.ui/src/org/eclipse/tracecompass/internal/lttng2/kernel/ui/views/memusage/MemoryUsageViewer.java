        ...
        try {
            ...
            while (!complete && currentEnd < end) {
                ...
                for (int quark : tidQuarks) {
                    ...
                    fMemoryQuarks.put(quark, ss.getQuarkRelative(quark, KernelMemoryStrings.KERNEL_MEMORY_MEMORY_ATTRIBUTE));
                    int procNameQuark = ss.getQuarkRelative(quark, KernelMemoryStrings.KERNEL_MEMORY_PROCNAME_ATTRIBUTE);
                    try {
